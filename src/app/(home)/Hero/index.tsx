...
export default function Hero() {
  return (
    <section id="top" className="bg-white py-14 sm:py-20 md:py-28 px-4 sm:px-6">
      <motion.div
      ...
      >
        <div className="max-w-3xl flex flex-col gap-6 sm:gap-8">
          <motion.h1
            variants={fadeUp}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0D0D0D] leading-[1.1] tracking-tight"
          >
            {heroContent.heading}
          </motion.h1>
          <motion.p
